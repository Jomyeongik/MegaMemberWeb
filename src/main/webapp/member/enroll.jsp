		...
		<form action="/member/register.do" method="post">
			<fieldset>
				...
				<ul>
					...
					<li>
						<label>성별</label>
						남<input type="radio" id="member-gender" name="member-gender" value="M"><!--기능을 위한 id, 쿼리스트링 생성을 위한 name -->
						여<input type="radio" id="member-gender" name="member-gender" value="F"><!--기능을 위한 id, 쿼리스트링 생성을 위한 name --> 
					</li>
					<li>
						<label for="member-email">이메일</label>
						<input type="text" id="member-email" name="member-email"><!--기능을 위한 id, 쿼리스트링 생성을 위한 name --> 
					</li>
					<li>
