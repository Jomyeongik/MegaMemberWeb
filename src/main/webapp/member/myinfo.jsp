...
<%--					여<input type="radio" id="member-gender" name="member-gender"value="F" <c:if test="${member.memberGender eq 'F' }">checked</c:if>><!--기능을 위한 id, 쿼리스트링 생성을 위한 name --> --%>						
					</li>
					<li>
					...
					<li>
						...
						<input type="text" id="member-date"value="${member.memberDate}"readonly><!--기능을 위한 id, 쿼리스트링 생성을 위한 name --> 
					</li>
				</ul>
			</fieldset>
			<div>
